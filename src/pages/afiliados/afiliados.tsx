          ...
          <IonRow className="mt-2 px-3">
            <IonCol size="12" className="pb-3">
              ...
              >
                ...
                >
                  <IonImg src={"./images/filtros.svg"} className="w-24-p mr-0"/>
                </Link>
              </div>
            </IonCol>
          </IonRow>
                        ...
                        >
                          <div>
                            ...
                            <div className="d-flex justify-content-between">
                              <div className="fs-16 font-w500 mt-1 title">
                                <span className="w-100 text-info">{item.nombre}</span>
                              </div>
                              ...
                              {item.idfav === "" ? (
                                ...
                                >
                                  <FontAwesomeIcon
                                    icon={faHeart}
                                    className="fs-16 mr-0 float-right"
                                  />
                                </IonButton>
                              ) : (
                                <IonButton
                                ...
                                >
                                  <FontAwesomeIcon
                                    icon={faHeart}
                                    className="fs-16 mr-0 float-right fav-blue"
                                  />
                                </IonButton>
                              )}
                            </div>
