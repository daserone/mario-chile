...
import { grupoSanguineos, imgPerfil, calcularEdad } from "../../helpers";
import "./perfil.css";
const PerfilEditar = () => {
  ...
  useEffect(() => {
    const { edad: Edad } = calcularEdad(fechaNacimiento);
    setEdad(Edad);
  }, [fechaNacimiento]);
          ...
          <IonRow className="mt-4 px-3">
                ...
                <IonCardContent>
                  ...
                  <div className="text-center subir-perfil">
                    <button
                      ...
                      className="imagen__botton imagen_perfil_border"
                    >
                      {porcentage > 0 && (
            ...
            <IonCol>
              <div className="pt-2 text-center">
                <IonButton
                  className="button-central-deg px-4"
                  fill="clear"
                  onClick={handleEdit}
                >
                  Guardar
