...
const Discapacidad = () => {
  ...
  console.log(carnet.iddiscapacidad);
  return (
            ...
            <IonCol size="12" className="pb-3">
              <IonCard className="m-0 card-slide shadow-full">
                <IonCardContent className="card-content-slide">
                  <span className="font-w500 fs-16 text-info">
                    ...
                    <div className="certificado">
                      <IonRow className="">
                        ...
                        <IonCol size="5" className="info-carnet">
                          ...
                          <div className="font-w700 d-block">NACIONALIDAD</div>
                        ...
                        <IonCol
                          size="3"
                          className="info-carnet pl-2"
                          style={{ marginTop: "1.3rem" }}
                        >
                          <div className="font-w700 d-block">EXPEDICIÓN</div>
                          <div className="font-w700 text-uppercase d-block mb-2">
                            {carnet.expedicion}
                          </div>
